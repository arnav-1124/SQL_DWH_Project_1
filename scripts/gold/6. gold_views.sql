...
CREATE VIEW gold.dim_product AS
	...
	ON pri.cat_id = pc.id
	WHERE pri.prd_end_dt IS NULL		-- filter out historized product data and take info of only currently available product
);


-- Creating Virtual Table for Sales Information:
